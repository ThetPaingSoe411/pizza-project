                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('product#Create')}}" method="post" novalidate="novalidate"enctype="multipart/form-data">
                           ...
                           <select name="pizzaCategory"class="form-control @error('pizzaCategory') is invaild @enderror">
                           ...
                           @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="pizzaDescription" class="form-control @error('pizzaDescription') is invaild @enderror" cols="30" rows="10"placeholder="Enter  description..">
                                    {{old('pizzaDescription')}}
                                </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaPrice" type="number"value="{{old('pizzaPrice')}}"
                                 class="form-control @error('pizzaPrice') is invaild @enderror" aria-required="true"
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaWaitingTime" type="number"value="{{old('pizzaWaitingTime')}}"
                                 class="form-control @error('pizzaWaitingTime') is invaild @enderror" aria-required="true"
