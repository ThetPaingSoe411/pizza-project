        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    ...
                    <form>
                        <div class=" d-flex align-items-center justify-content-between mb-3 px-3 py-1 bg-dark text-white">
                            <label class="" for="price-all">Categories</label>
                            <button type="button" class="btn btn-primary rounded-bottom">
                        ...
                        <div class=" d-flex align-items-center justify-content-between mb-3">
                            <a href="{{route('user#home')}}"class="text-dark">
                                <label class="" for=""type="" name="" class="form-control">All</label>
                           </a>
                        </div>
                        @foreach ($category as $c )
                        <div class=" d-flex align-items-center justify-content-between mb-3">
                        <a href="{{route('user#filter',$c->id)}}"class="text-dark">
                            <label class="" for=""type="" name="" class="form-control">{{$c->name}}</label>
                       </a>
                    </div>
                    @endforeach
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 pb-1" >
                         <div class="product-item bg-light mb-4"id="myForm" >
                             <div class="product-img position-relative overflow-hidden">
                                 <img class="img-fluid w-100" src="{{asset('storage/'.$p->image)}}" alt="" style="height:210px">
                 ...
                 @endforeach
                     @else
                     <h4 class="text-muted text-center bg-secondary"><i class="fa-solid fa-pizza-slice me-2"></i>There is no pizzas</h4>
                     @endif
                    </div>
        ...
        success:function(response){
            ...
            for($i=0; $i<response.length; $i++ ){
                $list +=` <div class="col-lg-4 col-md-6 col-sm-6 pb-1" >
                            <div class="product-item bg-light mb-4"id="myForm" >
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{asset('storage/${response[$i].image}')}}" alt="" style="height:210px">
                                 <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
